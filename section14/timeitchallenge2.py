...
#result_iter = timeit.timeit("x = fact(130)", setup="from __main__ import fact", number=1000)
#result_recur = timeit.timeit("y = factorial(130)", setup="from __main__ import factorial", number=1000)
#
