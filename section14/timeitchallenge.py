...
result_iter = timeit.timeit(fact_test, number=1000)
result_recur = timeit.timeit(factorial_test, number=1000)

print("iterative solution result: {}".format(result_iter))
print("recursive solution result: {}".format(result_recur))
