    ...
    with open("albums.txt", "r") as albums:
        for line in albums:
            ...
            if new_artist is None:
                ...
                # Store current album in the current artist  collection then create a new artist object
            ...
            if new_album is None:
                ...
                # store the current album in the artist's collection then create a new album obj
                new_artist.add_album(new_album)
                new_album = Album(album_field, year_field, new_artist)
