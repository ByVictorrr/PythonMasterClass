...
class Album:
    ...
    def add_song(self, song, position=None):
        ...
        if song_found is None:
            sound_found = Song(song, self.artist)
            if position is None:
...
class Artist:
    ...
    def add_song(self, name, year, title):
        ...
        This method will add the song to an ablum in the collection.
        A new album will be created in the collection if it doesnt already exists
        ...
        for new_artist in artist_list:
            for new_album in new_artist.albums:
                for song in new_album.tracks:
                    # data row should consist of (artist, album, year, song)
                    print("{}\t{}\t{}\t{}".format(new_artist.name, new_album.name, new_album.year, song.name),file=checkFile)
