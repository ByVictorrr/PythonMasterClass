...
class DocType(Tag):
	...
	def __init__(self):
		...
		self.end_tag = "" # doesnt have a end tag
...
class Head(Tag):
	...
	def add_tag(self, name, contents):
		...
		self._title_contents.append(new_tag)
...
class Body(Tag):
	...
	def __init__(self):
		super().__init__("body", "") # body contents will be built in sep
		self._body_contents = []
...
if __name__ == "__main__":
	my_page = HtmlDoc("this is my title")
...
new_body.add_tag("p", "The composed object doesnt actually own the objects that its composof - if it's destroyed those objects continue to exist.")
