...
db.execute("CREATE TABLE IF NOT EXISTS history (utc_time TIMESTAMP NOT NULL, local_time TIMESTAMP NOT NULL, account TEXT NOT NULL, amount INTEGER NOT NULL, PRIMARY KEY (utc_time, account))")
...
class Account(object):
	...
	def _save_update(self, amount):
		...
		db.execute("INSERT INTO history VALUES(?,?,?,?)",(deposit_time, deposit_time.astimezone(), self.name, amount))
		db.commit()
