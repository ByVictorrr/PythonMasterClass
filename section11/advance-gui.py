...
# colunspan = spans over 3 columns
...
# nsew - expand all horizonally and vertically
...
# Buttons
okBtn = tkinter.Button(mainWindow, text="ok")
cancelBtn = tkinter.Button(mainWindow, text="cancel", command=mainWindow.destroy)

okBtn.grid(row=4, column=3, sticky='e')
cancelBtn.grid(row=4, column=4, sticky='w')
