# Challenge: include a button to reset cards and score
import random
try:
    import tkinter
...
############3Reset button #################
reset_btn = tkinter.Button(btn_frame, text="New Hand", command=new_hand)
reset_btn.grid(row=0, column=2)

####################################

shuffle_btn = tkinter.Button(btn_frame, text="Shuffle", command=shuffle)
